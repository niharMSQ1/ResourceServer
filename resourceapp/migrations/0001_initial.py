    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elastic_ip_type', models.CharField(choices=[('Public IP', 'PUBLIC_IP'), ('Private IP', 'PRIVATE_IP')], default='Public IP', max_length=20)),
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
                ('ec2_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resourceapp.ec2')),
                ('organisation_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resourceapp.organisation')),
            ],
        ),
        migrations.AddField(
            model_name='ec2',
            name='organisation_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resourceapp.organisation'),
        ),
        migrations.AddField(
            model_name='ec2',
            name='vpc_id',
